Contributing to Specialcoin Core
============================

The Specialcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Specialcoin Core project, and is not to be
confused with overall Specialcoin Network Protocol consensus changes.

Whether a pull request is merged into Specialcoin Core rests with the project merge
...
Patches that change Specialcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Specialcoin consensus, it must have been
...
The project leader is the release manager for each Specialcoin Core release.
