...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/specialcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/specialcoin-cli.cpp \
           src/specialcoin-tx.cpp \
           src/specialcoin.cpp \
           src/db.cpp \
           ...
           src/qt/specialcoin.cpp \
           src/qt/specialcoinstrings.cpp \
...
RESOURCES += src/qt/specialcoin.qrc src/qt/specialcoin_locale.qrc

TRANSLATIONS += src/qt/locale/specialcoin_bg.ts \
                src/qt/locale/specialcoin_de.ts \
                src/qt/locale/specialcoin_en.ts \
                src/qt/locale/specialcoin_es.ts \
                src/qt/locale/specialcoin_fi.ts \
                src/qt/locale/specialcoin_fr.ts \
                src/qt/locale/specialcoin_it.ts \
                src/qt/locale/specialcoin_ja.ts \
                src/qt/locale/specialcoin_pl.ts \
                src/qt/locale/specialcoin_pt.ts \
                src/qt/locale/specialcoin_ru.ts \
                src/qt/locale/specialcoin_sk.ts \
                src/qt/locale/specialcoin_sv.ts \
                src/qt/locale/specialcoin_vi.ts \
                src/qt/locale/specialcoin_zh_CN.ts \
                src/qt/locale/specialcoin_zh_TW.ts
