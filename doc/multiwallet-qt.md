...
In order to support loading of multiple wallets in specialcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is specialcoin.cpp.
...
Changes to specialcoin.cpp
----------------------
specialcoin.cpp is the entry point into specialcoin-qt, and as such, will require some minor modifications to provide hooks for
