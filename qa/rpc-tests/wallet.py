...
#   c) node1 mines 32 blocks, so now node 0 has 60001spcc, node 1 has 4250spcc, node2 has none.
#   d) node0 sends 601 spcc to node2, in two transactions (301 spcc, then 300 spcc).
