                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Specialcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Specialcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and specialcoin: URIs)"));
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSPCC"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Specialcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Specialcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Specialcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Specialcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Specialcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Specialcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Specialcoin Core help message to get a list with possible Specialcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Specialcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Specialcoin network", "", count));
}
...
{
    QString strTitle = tr("Specialcoin Core"); // default title
