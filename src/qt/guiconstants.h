...
/* Specialcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Specialcoin"
#define QAPP_ORG_DOMAIN "specialcoin.tech"
#define QAPP_APP_NAME_DEFAULT "Specialcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Specialcoin-Qt-testnet"
