...
/** Utility functions used by the Specialcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Specialcoin addresses in monospace font
...
// Parse "specialcoin:" URI into recipient object, return true on successful parsing
