...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Specialcoin Core"),
     ...
     * override -datadir in the specialcoin.conf file in the default data directory
     * (to be consistent with specialcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
