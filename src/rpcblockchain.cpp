...
/*
    ...
    result.push_back(Pair("zSPCCsupply", zndbObj));
*/
    return result;
}
...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in specialcoin\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of specialcoin addresses\n"
            "     \"specialcoinaddress\"   	 	(string) specialcoin address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
