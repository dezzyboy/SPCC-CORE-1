...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Specialcoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Specialcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Specialcoin features */
        {"specialcoin", "masternode", &masternode, true, true, false},
        {"specialcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"specialcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"specialcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"specialcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"specialcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"specialcoin", "startmasternode", &startmasternode, true, true, false},
        {"specialcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"specialcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"specialcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"specialcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"specialcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"specialcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"specialcoin", "mnbudget", &mnbudget, true, true, false},
        {"specialcoin", "preparebudget", &preparebudget, true, true, false},
        {"specialcoin", "submitbudget", &submitbudget, true, true, false},
        {"specialcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"specialcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"specialcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"specialcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"specialcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"specialcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"specialcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"specialcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"specialcoin", "mnsync", &mnsync, true, true, false},
        {"specialcoin", "spork", &spork, true, true, false},
        {"specialcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"specialcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> specialcoin-cli " + methodname + " " + args + "\n";
}
