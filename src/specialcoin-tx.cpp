...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Specialcoin Core specialcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  specialcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded specialcoin transaction") + "\n" +
                               "  specialcoin-tx [options] -create [commands]   " + _("Create hex-encoded specialcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded specialcoin transaction
